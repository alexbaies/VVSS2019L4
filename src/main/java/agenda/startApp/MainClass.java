...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        final String filenameActivity = "E:\\VVSS2019\\ProiectAgenda\\files\\activities.txt";
        final String filenameContact = "E:\\VVSS2019\\ProiectAgenda\\files\\contacts.txt";
        final String filenameUser = "E:\\VVSS2019\\ProiectAgenda\\files\\users.txt";
